            ...
            <div className="flex-1 space-y-5 relative z-20">
              ...
              >
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h1 className="text-lg font-bold text-white tracking-wide leading-none">NOOR</h1>
                    <span className="text-[9px] text-white/50 tracking-[0.1em] uppercase">Islamic Companion</span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex items-center gap-2 bg-amber-400/15 backdrop-blur-sm rounded-full px-4 py-2 border border-amber-400/30">
